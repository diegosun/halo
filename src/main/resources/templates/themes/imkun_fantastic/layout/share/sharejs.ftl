...
<link rel="stylesheet" href="${theme_base!}/source/npm/social-share.js@1.0.16/dist/css/share.min.css">
<script src="${theme_base!}/source/npm/social-share.js@1.0.16/dist/js/social-share.min.js"></script>
<style>
    <#if is_post??>
    .social-share a {
