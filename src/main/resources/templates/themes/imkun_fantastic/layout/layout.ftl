<#macro layout title,canonical>
    ...
    <head>
        ...
        <link rel="stylesheet" href="${theme_base!}/source/npm/bulma@0.7.5/css/bulma.min.css">
        <link rel="stylesheet" href="${theme_base!}/source/releases/v5.4.1/css/all.css">
        <link rel="stylesheet" href="${theme_base!}/source/releases/fonts.css">
        <#--        <link rel="stylesheet" href="${theme_base!}/source/npm/highlight.js@9.12.0/styles/atom-one-light.css">-->
        <style>
            body > .footer,
            body > .navbar,
            body > .section {
        ...
        <#if is_post?? || is_sheet??>
            <link rel="stylesheet" href="${theme_base!}/source/npm/lightgallery@1.6.8/dist/css/lightgallery.min.css">
            <link rel="stylesheet"
                  href="${theme_base!}/source/npm/justifiedGallery@3.7.0/dist/css/justifiedGallery.min.css">
        </#if>
        <link rel="stylesheet"
              href="${theme_base!}/source/npm/outdatedbrowser@1.1.5/outdatedbrowser/outdatedbrowser.min.css">
        <script src="${theme_base!}/source/npm/pace-js@1.0.2/pace.min.js"></script>
        ...
        <#if is_index??>
            ...
            <link rel="stylesheet" href="${theme_base!}/source/npm/ajax/libs/Swiper/4.3.5/css/swiper.min.css">
        </#if>
    </head>
